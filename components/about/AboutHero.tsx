...
export default function AboutHero() {
  return (
    <section className="relative pt-32 pb-24 px-6 flex justify-center">
      <motion.div 
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
        className="identity-card max-w-2xl w-full rounded-[3rem] p-10 md:p-14 relative overflow-hidden group"
      >
        ...
        <div className="flex flex-col items-center text-center relative z-10">
          ...
          {/* Avatar Section */}
          <div className="relative mb-12 group/avatar cursor-default">
            <div className="w-32 h-32 md:w-36 md:h-36 rounded-[2.5rem] overflow-hidden border border-white shadow-xl relative z-10 bg-white p-1.5">
              <Image 
            ...
            <motion.div
              ...
              className="absolute -inset-6 border border-dashed border-cyan-400/20 rounded-[3.5rem] pointer-events-none opacity-40 group-hover/avatar:opacity-80 transition-opacity"
            />
            ...
            <motion.div
              ...
              className="absolute -inset-3 border border-dashed border-blue-400/30 rounded-[3rem] pointer-events-none opacity-50 group-hover/avatar:opacity-100 transition-opacity"
          ...
          <div className="space-y-4 mb-10">
            ...
            <p className="text-lg md:text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 leading-none">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <div className="flex gap-2">
              {[
                ...
                { icon: <Mail size={18} />, href: "mailto:josephchen.dev@gmail.com", label: "Email" }
              ].map((social, i) => (
                <Button
                  key={i}
                  as={Link}
