              ...
              <Card className="border-none bg-white shadow-[0_20px_50px_rgba(0,0,0,0.05)] overflow-hidden group">
                <CardBody className="p-0">
                  <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-0">
                    ...
                    <div className="bg-gray-50/50 flex items-center justify-center p-8 lg:p-16 relative overflow-hidden group-hover:bg-blue-50/50 transition-colors duration-500 min-h-[400px]">
                      <motion.div
                        whileHover={{ scale: 1.05, rotate: 2 }}
                        transition={{ duration: 0.5 }}
                        className="relative z-10 w-full h-full max-w-[450px] aspect-square"
                      >
                        <NextImage
                          src={project.image}
                          alt={project.title}
                          ...
                          className="shadow-2xl rounded-2xl border-none object-contain transition-all duration-500 p-4 bg-white"
                          priority={index === 0}
                        />
                      </motion.div>
                      {/* Decorative elements */}
