...
export default function Footer() {
    ...
    return (
        <footer className="bg-white py-2 mt-auto d-flex align-items-center">
            <div className="container px-4">
                <div className="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div className="col-auto">
                        ...
                        <div className="small m-0 text-muted" style={{ opacity: 0.8, fontSize: '0.7rem' }}>
                    ...
                    <div className="col-auto" style={{ fontSize: '1.2em', marginRight: '10px' }}>
                        <a
