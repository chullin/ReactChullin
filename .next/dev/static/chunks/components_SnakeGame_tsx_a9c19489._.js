...
"[project]/components/SnakeGame.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SnakeGame() {
    ...
    const directionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        dx: 0,
        dy: 0
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SnakeGame.useEffect": ()=>{
            ...
            if (!ctx) return;
            const generateFood = {
                "SnakeGame.useEffect.generateFood": ()=>{
                    let newFoodPosition = {
                        x: 0,
                        y: 0
                    };
                    while(true){
                        ...
                        const overlap = snakeRef.current.some({
                            "SnakeGame.useEffect.generateFood.overlap": (segment)=>segment.x === newFoodPosition.x && segment.y === newFoodPosition.y
                        }["SnakeGame.useEffect.generateFood.overlap"]);
                        if (!overlap) break;
                    }
            ...
            const draw = {
                "SnakeGame.useEffect.draw": ()=>{
                    ...
                    snakeRef.current.forEach({
                        "SnakeGame.useEffect.draw": (segment, index)=>{
            ...
            const handleKeyDown = {
                "SnakeGame.useEffect.handleKeyDown": (e)=>{
                    const { dx, dy } = directionRef.current;
                    const gameKeys = [
                        'ArrowUp',
                        'ArrowDown',
            ...
            }["SnakeGame.useEffect.handleKeyDown"];
            const handleTouchStart = {
                "SnakeGame.useEffect.handleTouchStart": (e)=>{
                    touchStartRef.current = {
                        x: e.touches[0].clientX,
                        y: e.touches[0].clientY
                    };
                }
            }["SnakeGame.useEffect.handleTouchStart"];
            const handleTouchMove = {
                "SnakeGame.useEffect.handleTouchMove": (e)=>{
            ...
            }["SnakeGame.useEffect.handleTouchMove"];
...
_s(SnakeGame, "YYRxzPeFXz3r6sPSx+U+RvBlZc4=");
_c = SnakeGame;
var _c;
...
//# sourceMappingURL=components_SnakeGame_tsx_a9c19489._.js.map