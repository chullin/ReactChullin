...
export const metadata: Metadata = {
  title: 'PyTorch 入門 AI 工程師必備基礎 | Joseph Chen',
  description: 'Tensor 操作、autograd、訓練迴圈 — 從 NumPy 思維到深度學習框架',
  alternates: {
    canonical: 'https://chullin.tw/blog/python/ep02-pytorch',
  },
};
  ...
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center space-y-5">
          <FadeIn>
            <div className="flex justify-center gap-2 mb-5">
              <span   className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-slate-100 text-slate-800 bg-orange-500/20 text-orange-200 border-orange-500/30 font-bold uppercase text-[10px]">
                Python 系列
              </span>
              <span   className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-slate-100 text-slate-800 bg-orange-500/20 text-orange-200 border-orange-500/30 font-bold uppercase text-[10px]">
                EP.02
      ...
      <article className="max-w-3xl mx-auto px-6 py-16 space-y-16">
        ...
        {/* Opening Quote */}
        <section>
          <div className="rounded-2xl border border-gray-100 bg-white shadow-sm border border-orange-100 bg-gradient-to-br from-orange-50 to-rose-50 shadow-none">
            <div className="p-7">
