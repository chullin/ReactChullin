          ...
          <div className="space-y-12">
            <section>
              <h3 className="text-xl font-black mb-6 flex items-center gap-3">
                <Code className="text-slate-400" size={20} /> Core Stack
              </h3>
              <div className="space-y-8">
                <div>
                  <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-4">AI & Automation</h4>
                  <div className="flex flex-wrap gap-2">
                    {['Ollama', 'Dify', 'OpenCV', 'Python Automation', 'PyTorch'].map(skill => (
                      <Chip key={skill} size="sm" variant="flat" className="bg-slate-100 text-slate-700 font-bold">{skill}</Chip>
                    ))}
                  </div>
                </div>
                <div>
                  <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-4">Backend & Systems</h4>
                  <div className="flex flex-wrap gap-2">
                    {['Python', 'FastAPI', 'Docker', 'Linux', 'PostgreSQL', 'Redis'].map(skill => (
                      <Chip key={skill} size="sm" variant="flat" className="bg-slate-100 text-slate-700 font-bold">{skill}</Chip>
                    ))}
                  </div>
                </div>
                <div>
                  <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-4">Frontend</h4>
                  <div className="flex flex-wrap gap-2">
